...
class CustomizableProductDetail(Base):
    __tablename__ = "agent_vw_customizable_products_details_master"
    ...
    options_groups = Column(JSON, nullable=True)

    def __repr__(self):
        return f"<CustomizableProductDetail(product_id={self.product_id}, product_name='{self.product_name}')>"

    def to_dict(self) -> CustomizableProductDetailDict:
        return {
            ...
            "options_groups": self.options_groups,
        }
